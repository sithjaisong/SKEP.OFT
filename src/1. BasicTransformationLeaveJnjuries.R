##'Title : R Script for extract format for SKEP OnFarm Trial
##'Created by : Sith Jaisong
##'Purpose : 
##'
##'

#####---- Step 1 : Load Library
#install.packages("XLConnect) # if there is no this package in your R
library(XLConnect)
#vignette("XLConnect") # if you need to know about funtions in this package
#help(XLConnect) # if you need help
library(dplyr) # Data manipulation
#library(agricolae) # computation AUDPC
...
#paste("SKEPII.DS2014.",trt[1], sep ="")


wb <- loadWorkbook(paste("R.SKEPII.",trt[i],".DS2014.SJ.xlsx", sep = ""), create = TRUE)
createSheet(wb, name = "sheet1")
createSheet(wb, name = "sheet2")
createSheet(wb, name = "sheet3")
createSheet(wb, name = "sheet4")

writeWorksheet(wb, injleave.total, sheet = "sheet1")
writeWorksheet(wb, injsys.total, sheet = "sheet2")
writeWorksheet(wb, injweed.total, sheet = "sheet3")
writeWorksheet(wb, yield.total, sheet = "sheet4")
